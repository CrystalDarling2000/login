  ...
  Widget build(BuildContext context) {
    ...
    final BMIController = TextEditingController();
     ...
     void  handle(){
      ...
      db.set({'age':age,'gender':gender,'smoker':smoker,'hb':hb,'systolicBP':systolicBP,'diastolicBP':DiastolicBP,'bmi':BMI});
  };
    ...
    return Scaffold(body: Column(children: [
      TextField(
        ...
        decoration: InputDecoration(hintText: 'Smoker',),
        ),
        TextField(
        controller: hbCountController,
        decoration: InputDecoration(hintText: 'Hb Count',),
        ),
        TextField(
        controller:SystolicBPController,
        decoration: InputDecoration(hintText: 'Systolic BP',),
        ),
        TextField(
        controller:DiastolicBPController,
        decoration: InputDecoration(hintText: 'Diastolic BP',),
        ),
        TextField(
